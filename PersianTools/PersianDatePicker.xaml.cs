...
namespace PersianTools
{
    ...
    public partial class PersianDatePicker : UserControl
    {
        ...
        static PersianDatePicker()
        {
            ...
            PropertyMetadata displayDateStartMetaData = new PropertyMetadata(PersianDate.MinValue);
            ...
            PropertyMetadata displayDateEndMetaData = new PropertyMetadata(PersianDate.MaxValue);
